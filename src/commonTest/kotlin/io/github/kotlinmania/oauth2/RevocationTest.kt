...
class RevocationTest {
    ...
    fun testTokenRevocationWithNonHttpsUrl() {
        ...
        val err = assertFailsWith<ConfigurationError.InsecureUrl> {
            client.setRevocationUrl(RevocationUrl.new("http://revocation/url"))
    ...
    fun testTokenRevocationWithRefreshToken() {
        ...
        client.revokeToken(StandardRevocableToken.from(RefreshToken.new("refresh_token_123")))
            .request(httpClient)
    }
}
