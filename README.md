...
Kotlin Multiplatform line-by-line clean-room port of the Rust crate [`oauth2`](https://crates.io/crates/oauth2).

> **Status: scaffold — porting has not started.** This repo currently contains build infrastructure only. The upstream Rust source for the `oauth2` crate will be cloned into `tmp/` (gitignored) when porting begins.

## About

Strongly-typed OAuth2 client
...
Original work copyrighted by the upstream `oauth2` authors. Kotlin port copyright (c) 2026 Sydney Renee and The Solace Project.
