...
kotlin {
    ...
    val xcf = XCFramework("Oauth2")

    macosArm64 {
        binaries.framework { baseName = "Oauth2"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Oauth2"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Oauth2"
        flattenPackage = "io.github.kotlinmania.oauth2"
    }

    android {
        namespace = "io.github.kotlinmania.oauth2"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "oauth2-kotlin", version.toString())

    pom {
        name.set("oauth2-kotlin")
        description.set("Kotlin Multiplatform port of ramosbugs/oauth2-rs - An extensible, strongly-typed implementation of OAuth2")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/oauth2-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/oauth2-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/oauth2-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/oauth2-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleOauth2XCFramework",
    "assembleOauth2DebugXCFramework",
    "assembleOauth2ReleaseXCFramework",
    "assembleDebugIosFatFrameworkForOauth2XCFramework",
    "assembleReleaseIosFatFrameworkForOauth2XCFramework",
    "assembleDebugIosSimulatorFatFrameworkForOauth2XCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForOauth2XCFramework",
    "assembleDebugMacosFatFrameworkForOauth2XCFramework",
    "assembleReleaseMacosFatFrameworkForOauth2XCFramework",
    "assembleDebugTvosFatFrameworkForOauth2XCFramework",
    "assembleReleaseTvosFatFrameworkForOauth2XCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForOauth2XCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForOauth2XCFramework",
    "assembleDebugWatchosFatFrameworkForOauth2XCFramework",
    "assembleReleaseWatchosFatFrameworkForOauth2XCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForOauth2XCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForOauth2XCFramework",
