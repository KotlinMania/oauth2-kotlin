...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Oauth2.swiftmodule/`
...
//      `import Oauth2` above would fail at compile time.
//
//   2. The static archive `libOauth2.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Oauth2" }` and
//      `flattenPackage = "io.github.kotlinmania.oauth2"` configuration in
...
final class Oauth2ExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Oauth2 swift module imported cleanly")
    }
}
