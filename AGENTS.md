...
This file is the quick-reference operating contract for oauth2-kotlin. The longer
...
oauth2-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`oauth2`](https://crates.io/crates/oauth2). Upstream Rust is the behavioral oracle while the
